...
//      RCC_PREDIVConfig(RCC_PREDIV2_Div4);
...
int GPIO_Configuration(void)
{
    ...
    * immunity against EMI/EMC */
    ...
    GPIO_Init(GPIOA, &GPIO_InitStructure);                  //∏˘æ›…Ë∂®≤Œ ˝≥ı ºªØGPIOB.5
...
void reset_DW1000(void)
{
    ...
    GPIO_SetBits(DW1000_RSTn_GPIO, DW1000_RSTn);    // ÂÆòÊñπÔºö‰øÆÂ§çÂç≥‰ΩøËΩØÁ°¨Â§ç‰ΩçËé∑Âèñ‰∏çÂà∞IDÂè∑ÈóÆÈ¢ò
...
static void MX_I2C1_Init(void)
{
    ...
    I2C_InitStructure.I2C_ClockSpeed = 400000;  /* 100KÀŸ∂» */
